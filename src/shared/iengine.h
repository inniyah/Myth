...
extern void lightreaching(const vec3 &target, vec3 &color, vec3 &dir, bool fast = false, extentity *e = 0, float minambient = 0.1f);
...
extern void regularshape(int type, int radius, int color, int dir, int num, int fade, const vec3 &p, float size = 4.0f, float vel = 200.0f, int gravity = 2 );
